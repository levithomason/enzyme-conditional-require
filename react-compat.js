...
/* -----------------------------------------------------------------------------------------
/* CHANGE
/* + */ const reactContextPath = REACT013 ? 'react/lib/ReactContext' : 'empty'
/* + */ const executionEnvironmentPath = REACT013 ? 'react/lib/ExecutionEnvironment' : 'empty'
// ------------------------------------------------------------------------
...
if (REACT013) {
  ...
  /* + */ const ReactContext = require(reactContextPath);
  // ------------------------------------------------------------------------
  ...
  /* + */ require(executionEnvironmentPath).canUseDOM = true;
  // ------------------------------------------------------------------------
